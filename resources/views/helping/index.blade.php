<x-app-layout>
    ...
    <div class="grid grid-cols-[1fr] md:grid-cols-[3fr_7fr] px-4 md:overflow-y-hidden">
        ...
        <div class="flex flex-col items-center justify-center mb-8 mt-16">
            ...
            <p class="italic mx-4 -mt-4 md:-mt-0 md:block text-center text-sm md:text-[1rem]">Bewegung hält frisch! Freiwilligenarbeit, Organisationen oder auch Privat. Hier können Sie ihr Vorhaben stellen und eventuell schon bald eine Helfende Hand finden.</p>
