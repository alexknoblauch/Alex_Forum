<x-app-layout>
    ...
    <div class="grid grid-cols-[1fr] md:grid-cols-[3fr_7fr] px-4 md:overflow-y-hidden max-h-[calc(100vh-3rem)] ">
        ...
        <div class="flex flex-col items-center justify-center mb-8 mt-16">
            ...
            <p class="italic mx-4 -mt-4 md:-mt-0 md:block text-center text-sm md:text-m">Teilen auch Sie Ihre liebsten Rezepte mit Anderen. <br> <span class="md:block hidden">Unser aller Liebling, das Essen, kann einen schwungvollen Twist in den Tag bringen.</span></p>
                <div class="flex justify-center flex-row mt-16 p-4 -ml-8 md:-ml-0">
    ...
    <script type="module" src="{{ asset('js/main.js') }}">
        ...
        import { validateTitle } from './titleCheck';
        ...
        inputTitle.addEventListener('change', validateTitle(inputTitle, inputTitleError, cookingTitles))
