...
<x-app-layout>
    ...
    <div class="grid grid-cols-[1fr] md:grid-cols-[3fr_7fr] px-4 md:overflow-y-hidden">
        <div class="mb-2flex flex-col gap-2 md:border-r md:border-gray-300 order-2 md:order-1 max-h-[calc(100vh-3rem)] md:overflow-y-auto overflow-y-visible scroll-container ">
            ...
            <div>
                ...
                @endforeach
            <div>
                <svg class="cursor-pointer btn-travel fixed bottom-[4%] right-[2%] sm:bottom-[50%] sm:right-[67.85%] h-[3rem] w-[3rem] p-2 bg-blue-300 border rounded-xl z-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 144L48 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l144 0 0 144c0 17.7 14.3 32 32 32s32-14.3 32-32l0-144 144 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-144 0 0-144z"/></svg>
            </div>
            </div>
        </div>
        <div class="md:p-12 p-6 -mt-12 text-center leading-[3rem] order-1 md:order-2 mb-8 max-h-[calc(100vh-3rem)] ">
            <a href={{route('welcome')}} class="md:hidden block mt-4 rounded-full p-2 bg-blue-300 w-[3.6rem] fixed top-12 md:left-6 left-[85%] cursor-pointer z-20">
            ...
            <div class="flex justify-center flex-row mt-16 p-4">
    ...
    <div class=" mt-24 md:mt-0">
        <div class=" modal hidden m-8 p-8 md:m-24 md:h-[65%] md:w-[60%] rounded-xl w-[90%] h-[65%] bg-white fixed inset-0 top-[40%] md:top-[30%] left-[45%] transform -translate-x-1/2 -translate-y-1/2  z-50">
            ...
            <form class="grid grid-rows-[2fr_8fr]" method="POST" action="{{route('travel.store')}}">
                @csrf
    ...
    <script>
        ...
        function getGemeindePreviews(inputText){
            ...
            const markup = matches.map(match => {
                ...
                return `<div class="px-2 py-1 hover:bg-gray-200 cursor-pointer rounded-l" data-id='${match.gemeinde}'>${highligted}</div>`}).join('');
