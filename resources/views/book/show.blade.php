      ...
      <div class="order-1 md:order-2 md:col-start-2 p-4 mt-16">
        <div class="flex flex-row mb-4">
          ...
          <div class="flex justify-center">
            <div class="absolute h-40 w-40 bg-green-300 rounded-full blur-2xl opacity-60 z-0"></div>
            <img class="ml-12 h-40 w-40  rounded-xl object-contain z-10" src="{{ asset('imgs/books/dieNeuenSeidenstrassen.webp') }}" alt="Foto des Gerichts">
          </div>
        </div>
