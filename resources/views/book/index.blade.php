<x-app-layout>
    ...
    <div class="grid grid-cols-[1fr] md:grid-cols-[3fr_7fr] px-4 md:overflow-y-hidden">
        <div class="flex flex-col gap-2 md:border-r md:border-gray-300 order-2 md:order-1 max-h-[calc(100vh-3rem)] md:overflow-y-auto overflow-y-visible">
            ...
            {{-- <a href="{{ route('book.show', ['slug' => Str::slug($book->title)]) }}">Link</a> --}}
                @foreach ($books as $book)
                    <a class="cursor-pointer hover:bg-gray-200 p-4 py-4 grid grid-cols-[8fr_2fr] mt-4 md:bg-inherit bg-[#EAECEF] rounded-[9px]">
                            <div>
        ...
        <div class="absolute top-10 left-2 w-16 h-16 bg-violet-300 rounded-lg rotate-6 opacity-30"></div>
        <div class="absolute top-[25%] left-1/4 w-24 h-24 bg-violet-400 rounded-md -rotate-12 opacity-30"></div>
        <div class="absolute bottom-20 left-10 w-20 h-20 bg-violet-500 rounded-lg rotate-3 opacity-30"></div>
        <div class="absolute bottom-5 left-1/6 w-32 h-32 bg-violet-300 rounded-xl rotate-12 opacity-30"></div>
        <div class="absolute top-1/2 left-1/9 w-12 h-12 bg-violet-400 rounded-md -rotate-3 opacity-30"></div>
        <div class="absolute top-1/4 left-[70%] w-14 h-14 bg-violet-500 rounded-lg rotate-2 opacity-30"></div>
        <div class="absolute top-[65%] left-[5%] w-20 h-20 bg-violet-400 rounded-md rotate-8 opacity-30"></div>
        <div class="absolute top-[75%] left-[90%] w-16 h-16 bg-violet-300 rounded-lg -rotate-10 opacity-30"></div>
        <div class="absolute bottom-[15%] left-[30%] w-28 h-28 bg-violet-500 rounded-xl rotate-5 opacity-30"></div>
        <div class="absolute top-[55%] left-[70%] w-10 h-10 bg-violet-400 rounded-md -rotate-6 opacity-30"></div>
    </div>
        ...
        <div class="flex flex-col items-center justify-center mb-8 mt-16 z-50">
            ...
            <p class="italic mx-4 -mt-4 md:-mt-0 md:block text-center text-sm md:text-m"> Was gibt es besseres als ein gutes Buch? Hier können Sie ihre lieblings Bücher rekommendieren und beschreiben um was es sich im Buch handelt.</p>
                <div class="flex flex-row align-center justify-center mt-16 p-4 -ml-8  md:-ml-0">
                    <img class="md:h-36 md:w-36 h-24 w-24 object-cover rounded-full -mr-12 border-white border-4 z-50"  src="{{asset('imgs/books/dasCafe.jpg')}}" alt="Bild einer Buchempfehlung">
                    <img class="md:h-36 md:w-36 h-24 w-24 object-cover rounded-full -mr-12 border-white border-4 z-50 "  src="{{asset('imgs/books/Mans-Search-for-Meaning.jpg')}}" alt="Bild einer Buchempfehlung">
                    <img class="md:h-36 md:w-36 h-24 w-24 object-cover rounded-full -mr-12 border-white border-4 z-50 "  src="{{asset('imgs/books/seidenstrassen.jpg')}}" alt="Bild einer Buchempfehlung">
                    <img class="md:h-36 md:w-36 h-24 w-24 object-cover rounded-full -mr-12 border-white border-4 z-50 "  src="{{asset('imgs/books/Der-kleine-prinz.jpg')}}" alt="Bild einer Buchempfehlung">
                    <img class="md:h-36 md:w-36 h-24 w-24 object-cover rounded-full -mr-12 border-white border-4 z-50 "  src="{{asset('imgs/books/spielDerZeit.jpg')}}" alt="Bild einer Buchempfehlung">
                    <img class="md:h-36 md:w-36 h-24 w-24 object-cover rounded-full -mr-12 border-white border-4 z-50 "  src="{{asset('imgs/books/sofiesWelt.jpeg')}}" alt="Bild einer Buchempfehlung">
                    <img class="md:h-36 md:w-36 h-24 w-24 object-cover rounded-full -mr-12 border-white border-4 z-50 "  src="{{asset('imgs/books/derAlchimist.jpg')}}" alt="Bild einer Buchempfehlung">
                </div>
        </div>
    </div>
    ...
    <div class="">
        <div class=" modal hidden m-8 p-8 md:m-24 h-[90%] w-[90%] md:h-[70%] md:w-[60%] rounded-xl  bg-white fixed inset-0 top-[50%] left-[40%] md:top-[30%] md:left-[45%] transform -translate-x-1/2 -translate-y-1/2  z-50">
                ...
                <div class="flex items-center justify-between mt-4">
                    <div class="flex md:flex-row flex-col imtes-center ustify-center gap-4 w-[100%]">
                        <div class="flex md:flex-row flex-col imtes-center ustify-center gap-4 w-[100%]">
                            ...
                            <input  class="rounded-xl outline-none focus:ring-0 focus:outline-none focus:border-gray-500 w-[100%] md:w-[70%]" name="title" id="title" type="text">
                            <label class="flex items-center justify-start  md:justify-center text-[20px] md:text-xl" for="title">Author:</label>
                            <input  class="rounded-xl outline-none focus:ring-0 focus:outline-none focus:border-gray-500 w-[100%] md:w-[70%]" name="author" id="author" type="text">
                        </div>
