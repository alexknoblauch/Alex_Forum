<x-app-layout>
  <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex items-center lg:justify-center flex-col h-screen overflow-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-[3fr_7fr] w-full max-w-7xl px-4 md:overflow-y-auto overflow-y-visible">
      ...
      <div class="max-h-[100vh] md:overflow-y-auto scroll-container p-4 order-2 md:order-1 md:col-start-1">
          ...
          <div class="hover:bg-gray-200 p-2 rounded-[9px] bg-[#EAECEF] flex flex-col gap-2 mb-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center  gap-2">
                    ...
                    <h3 class="text-[0.7rem] md:text-[0.9rem]">Alexander Knoblauch</h3>
                </div>
              <p class="flex-between mr-4 text-[0.7rem] md:text-[0.9rem]">#{{ 8 - $loop->index - 1 }}</p>
            </div>
            <p class="text-gray-700 text-[0.7rem] md:text-[0.7rem] w-[80%]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus placeat, pero este text ...</p>
          </div>
        @endforeach
            <textarea class="fixed bg-green-100 hover:bg-white hidden md:block bottom-1 left-8 md:text-[0.8rem] w-[27%] rounded-xl bg-gray-100 outline-none focus:ring-0 focus:border-black" placeholder="Dein Kommentar ..."></textarea>
      </div>
